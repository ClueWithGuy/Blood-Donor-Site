...
class Donation(db.Model):
    ...
    donor_school_id = db.Column( db.String(50), nullable=False)
...
class Message(db.Model):
    id = db.Column( db.Integer, primary_key=True)
    sender_school_id = db.Column( db.String(50), nullable=False)
    receiver_school_id = db.Column( db.String(50), nullable=False)
